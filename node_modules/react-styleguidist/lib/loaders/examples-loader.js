...
function examplesLoader(source) {
  ...
  _astTypes.builders.variableDeclaration('const', [_astTypes.builders.variableDeclarator(_astTypes.builders.identifier(`${name}$0`), (0, _requireIt.default)(requireRequest).toAST())]), // const name = name$0[name] || name$0.default || name$0;
  _astTypes.builders.variableDeclaration('const', [_astTypes.builders.variableDeclarator(_astTypes.builders.identifier(name), _astTypes.builders.logicalExpression('||', _astTypes.builders.identifier(`${name}$0['${name}']`), _astTypes.builders.logicalExpression('||', _astTypes.builders.identifier(`${name}$0.default`), _astTypes.builders.identifier(`${name}$0`))))])]))); // Stringify examples object except the evalInContext function
