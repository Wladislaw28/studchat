...
const configSchema = {
  ...
  getExampleFilename: {
    ...
    default: componentPath => {
      ...
      _path.default.join(_path.default.dirname(componentPath), _path.default.basename(_path.default.dirname(componentPath)) + '.md')]; // FIXME: This looks like a bug in ESLint
